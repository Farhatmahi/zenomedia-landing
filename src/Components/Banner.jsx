    ...
    <div className="border-l-8 border-primary">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 rounded-xl container mx-auto p-8 bg-white md:p-20">
        <div className="flex flex-col justify-center md:justify-start text-center lg:text-left space-y-8">
          ...
          <button className="bg-white w-full md:w-36 border-2 border-primary text-lg font-semibold text-primary px-8 py-2 rounded-3xl hover:bg-primary hover:text-white transition duration-300 ease-in-out">
            Try now
          </button>
        </div>
        <img
